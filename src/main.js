...
let targetParam11 = 0, currentParam11 = 0; // 🌟 新增：次級互動參數 (0=隱藏, 1=絲滑顯示)
...
function updateParams() {
  ...
  // 🌟 核心規則連動：若內褲已脫除 (targetParam10 === 1)，強制將衣服參數設定為 1 狀態（脫除），永不重新露出底褲
  if (targetParam10 === 1) {
    targetClothes = 1;
  }
        ...
        // 2. 縱向滑動：內褲與 Param11 階梯式多段控制核心
          ...
          if (diffY > 40) {
            if (targetParam10 === 0) {
              ...
              // 🌟 新增功能：內褲解除了，再次向上滑使 Param11 絲滑顯示 (1)
              targetParam11 = 1;
